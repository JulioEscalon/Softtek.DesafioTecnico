...
namespace Softtek.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Softtek.WebApi", Version = "v1" });
            });
            ...
            services.AddDbContext<ApiDbContext>(options =>
                ...
                b => b.MigrationsAssembly("Softtek.WebApi")));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Softtek.WebApi v1"));
            }
